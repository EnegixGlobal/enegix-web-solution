...
const reviews: Review[] = [
  ...
  },
  {
    id: 8,
    rating: 5.0,
    text: "Inka digital marketing ka kaam bahut hi behtarin h Maine socha tha ki ye to bekar hi hoga but ,in reality it is awesome their content are superb  and different from others. Social media pe hmare followers aur engagement to din pe din bdh gye ..thank you enegix web solution digital marketing team 👏👏👏👏👏 …",
    author: "Puja Kumari",
  ...
  },
  {
    id: 13,
    rating: 4.8,
    text: "Unhone hmara GMB listing itna optimize Kiya ki local search results mein phle page pe aane laga. Business  visibility kaafi  improve hua!",
    author: "Sabbu Jii",
    work: "Web Development",
    verified: true,
  },
