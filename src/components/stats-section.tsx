  ...
  return (
    <div className="relative w-full py-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="inline-block p-[1px] rounded-full bg-gradient-to-r from-blue-500 to-cyan-400">
            {" "}
            <button className="px-8 py-3 rounded-full bg-[#1e293b] text-white font-semibold hover:bg-gradient-to-r hover:from-blue-500 hover:to-cyan-400 transition-all duration-300 font-poppins text-sm tracking-wider">
              Start Your Project
            </button>
          </div>{" "}
        </motion.div>
