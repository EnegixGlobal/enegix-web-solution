...
const seoData = {
  "seo-optimization": {
    title: "SEO Company Ranchi, SEO Services India, Search Engine Optimization",
    description: "Leading SEO company in Ranchi providing comprehensive SEO services in India. Expert search engine optimization to boost your rankings and organic traffic.",
      ...
      <main className="bg-[#0c1220] text-white min-h-screen relative overflow-x-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <nav aria-label="Breadcrumb" className="mb-8">
              <ol className="flex items-center space-x-2 text-sm text-gray-400">
                ...
                <li className="text-gray-600">•</li>
                <li className="text-cyan-400 font-medium" aria-current="page">SEO Optimization</li>
              </ol>
            </nav>
            ...
            <article className="mb-20">
              ...
              >
                <h3 className="text-2xl md:text-3xl font-bold mb-6 tracking-tight">
                  <AuroraText>Search Engine Optimization Approaches That Are Future-Proof</AuroraText>
                </h3>
                <p className="text-gray-300 text-lg max-w-5xl mx-auto leading-relaxed">
                  Search engines are smarter than ever, and with them, your <span className="text-green-700 font-extrabold">Search Engine Optimization in India</span> strategy should be as well. At Enegix Web Solutions Pvt. Ltd., our approach is to optimize not only for algorithms but also for human behavior. From semantic search alignment to site enrichment, we make sure that your digital presence is meaningfully discoverable and sustainable. We blend structured data with user signals and content hierarchy to send a clear signal to search engines: "This is the best result." It is not about tricking the system, but about earning your place by relevance and experience.
                </p>
              </motion.div>
        ...
        <section className="py-20 px-4 relative">
          <div className="container mx-auto relative z-10">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Boost Your Rankings?</h2>
