...
const seoData = {
  "ppc-advertising": {
    title: "PPC Advertising Services | Performance Marketing & Paid Ads",
    description: "Drive immediate traffic and leads with expert PPC advertising services. Maximize ROI with targeted campaigns across Google Ads, Facebook, LinkedIn and more platforms.",
    keywords: "ppc advertising, google ads management, facebook ads, linkedin ads, paid advertising, performance marketing, lead generation",
    ...
    structuredData: {
      ...
      "description": "Performance-driven PPC advertising campaigns for immediate traffic and lead generation",
