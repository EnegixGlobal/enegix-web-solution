...
const services = [
  {
    ...
    fullDescription: "We craft responsive, high-performance websites and web applications tailored to your specific business needs. Our development team utilizes cutting-edge technologies like React, Next.js, and Node.js to deliver exceptional digital experiences that engage your audience and drive conversions.",
    features: [
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              ...
              >
                <h2 className="text-3xl font-bold mb-8 tracking-tight">
                  Our <AuroraText>{service.title}</AuroraText> Services Include
                </h2>
              ...
              >
                <h2 className="text-3xl font-bold mb-8 tracking-tight">Our Approach</h2>
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">We begin by understanding your business needs, goals, and target audience to create a tailored strategy.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">We implement the solution and thoroughly test all components to ensure quality and performance.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">After launch, we provide ongoing support and data-driven optimization to ensure continued success.</p>
                    </div>
                  </div>
                </div>
              </motion.div>
