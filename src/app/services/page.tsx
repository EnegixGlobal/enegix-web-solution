...
const seoData = {
  ...
  description: "Comprehensive digital solutions including web development, e-commerce, PPC advertising, SEO optimization, logo design, and digital marketing services.",
  keywords: "web development, digital marketing, ecommerce solutions, ppc advertising, seo optimization, logo design, ranchi web solutions",
...
const services = [
  {
    ...
    description: "Custom web solutions that drive business growth with responsive design, fast performance, and seamless user experience.",
    features: ["Custom Web Applications", "Responsive Design", "E-commerce Platforms", "CMS Development"],
  ...
  },
  {
    ...
    description: "Full-featured e-commerce platforms that convert visitors into customers with secure payments and smooth checkout.",
    features: ["Online Store Development", "Payment Integration", "Inventory Management", "Order Tracking"],
  ...
  },
  {
    ...
    shortDescription: "Comprehensive digital marketing strategies to grow your online presence and reach.",
    description: "Data-driven marketing campaigns across multiple channels to maximize your brand's online visibility and engagement.",
    features: ["Social Media Marketing", "Content Strategy", "Email Marketing", "Brand Development"],
  ...
  },
  {
    ...
    shortDescription: "Performance-driven paid advertising campaigns for immediate traffic and lead generation.",
    description: "Strategic PPC campaigns across Google Ads, Facebook, and LinkedIn that maximize ROI and drive qualified leads.",
    features: ["Google Ads Management", "Social Media Ads", "Landing Page Optimization", "Conversion Tracking"],
  ...
  },
  {
    ...
    shortDescription: "Technical SEO and content strategies for better search engine rankings and visibility.",
    description: "Comprehensive SEO strategies that improve your website's visibility and drive organic traffic from search engines.",
  ...
  },
  {
    id: "logo-design",
    title: "Logo Design",
    shortDescription: "Professional brand identity and logo design services for memorable brand recognition.",
    description: "Creative logo design and brand identity solutions that capture your brand's essence and leave lasting impressions.",
    features: ["Custom Logo Design", "Brand Identity", "Business Cards", "Brand Guidelines"],
    ...
    >
      ...
      <div className="relative h-48 bg-gradient-to-br from-teal-50 to-emerald-50 overflow-hidden">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className={`w-16 h-16 rounded-full bg-gradient-to-r ${service.color} flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}>
            {service.icon}
          </div>
        </div>
        {/* Decorative elements */}
  ...
  return (
    <>
      ...
      <main className="bg-white text-gray-900 min-h-screen relative overflow-x-hidden">
        {/* Hero Section */}
        <header className="relative pt-24 pb-16 px-6 lg:px-8 bg-gradient-to-br from-teal-50 via-emerald-50 to-white" role="banner">
          {/* Background decorative elements */}
          <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
            <div className="absolute top-20 left-1/2 transform -translate-x-1/2 w-[800px] h-[400px] opacity-10">
              <Meteors number={20} />
            </div>
            <div className="absolute top-1/4 left-1/4 w-[400px] h-[400px] rounded-full bg-teal-100 blur-3xl opacity-40" />
            <div className="absolute bottom-1/4 right-1/4 w-[300px] h-[300px] rounded-full bg-emerald-100 blur-3xl opacity-30" />
          </div>
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <nav aria-label="Breadcrumb" className="mb-8">
              <ol className="flex items-center space-x-2 text-sm text-teal-800/80">
                ...
                <li className="text-teal-700 font-medium" aria-current="page">Services</li>
              </ol>
            </nav>
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              >
                ...
                <h1 className="text-4xl lg:text-6xl font-bold leading-tight text-gray-900">
                  Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-emerald-600">Services</span>
                </h1>

                {/* Description */}
                <p className="text-gray-600 text-lg lg:text-xl leading-relaxed max-w-3xl mx-auto">
                  Comprehensive digital solutions designed to accelerate your business growth. From web development to digital marketing, we deliver results that matter.
                </p>
          ...
          <div className="container mx-auto max-w-7xl">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-6 tracking-tight text-gray-900">
                What We <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-emerald-600">Offer</span>
              </h2>
        ...
        <section className="py-20 px-4 bg-gradient-to-br from-teal-50 via-emerald-50 to-white">
          <div className="container mx-auto max-w-6xl">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-6 tracking-tight text-gray-900">
                Why Choose <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-emerald-600">Enegix</span>
              </h2>
              <p className="text-gray-600 text-lg leading-relaxed max-w-3xl mx-auto">
